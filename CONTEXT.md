...
**一词一页**:
搜索关键词、广告标题与页面主标题表述同一件事的投放承接原则；一个承接词组对应一张广告落地页。
_Avoid_: 多词合页, 一词多页

**承接词组**:
按搜索意图聚合的一组必应搜索关键词，是广告落地页、广告文案与来源参数的内容单位。
_Avoid_: 推广计划, 关键词分组

**钩子物料**:
广告落地页表单承诺交付、且必须真实能发出的资料；由解决方案顾问完成交付。
_Avoid_: 下载资料, 白皮书

**四处一致**:
承接词、广告标题、页面主标题与广告最终地址四处表述一致；是上线核对与广告落地页验证脚本的验收项。
_Avoid_: 文案对齐
