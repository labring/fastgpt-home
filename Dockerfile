...
ARG NEXT_PUBLIC_CLARITY_TONGJI
...
ARG NEXT_PUBLIC_CUSTOMERS_SOURCE

ENV NEXT_PUBLIC_BAIDU_TONGJI=$NEXT_PUBLIC_BAIDU_TONGJI
ENV NEXT_PUBLIC_CLARITY_TONGJI=$NEXT_PUBLIC_CLARITY_TONGJI
...
ENV NEXT_PUBLIC_CUSTOMERS_SOURCE=$NEXT_PUBLIC_CUSTOMERS_SOURCE
