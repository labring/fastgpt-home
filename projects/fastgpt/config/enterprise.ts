...
export const ENTERPRISE_SOLUTIONS_ZH = [
  {
    ...
    cases: [
      ...
      {
        title: "城市治理与应急响应",
        description: "运用 AI 技术实时分析城市数据，精准预测交通拥堵、环境污染等问题，突发事件中实时监控、数据分析快速启动应急预案，协调部门响应，全方位保障城市安全。",
      },
      {
        title: "政策智能决策支持",
  ...
  },
  {
    ...
    cases: [
      ...
      {
        title: "核保风险评估助手",
        description: "通过大模型构建智能知识库破解条款理解难题，保险产品对比 Agent 以可视化多维分析重塑产品决策体验，预核保场景应用大模型优化核保流程实现降本增效与风控升级。",
      },
      {
        title: "条款合规审查盾",
  ...
  },
  {
    ...
    cases: [
      ...
      {
        title: "现场作业辅助助手",
        description: "AI 助手为现场员工提供负荷接入方案、安全操作解答及培训支持，问题满足率达94%，年节省成本超百万元。",
      },
      {
        title: "方案设计助手",
      ...
      {
        title: "项目工程造价助手",
        description: "为解决项目维护中造价申报效率低、易出错的问题。该助手利用 AI 技术，实现申报内容智能识别、子项目自动关联、造价类目智能匹配及价格自动计算，一键生成标准化概算清单，提升申报效率与准确性。",
      },
      {
        title: "厂站填报助手",
  ...
  },
  {
    ...
    cases: [
      ...
      {
        title: "患者的智能医疗咨询",
        description: "1）生成结构化健康宣教方案，涵盖疾病预防、膳食营养、运动康复等场景；2）通过医院公众号、移动端 APP 及病房智能终端实现多模态内容推送；3）重塑就医服务链路，形成诊前教育-诊中指导-诊后随访的闭环管理，在提升患者健康素养的同时优化医疗资源配置效率。",
      },
      {
        title: "患者服务的智能导诊",
      ...
      {
        title: "医生提效智能病历",
        description: "1）基于医疗大模型构建智能中枢，实现病历文档的实时结构化生成；2）内置医学知识图谱与诊疗规范引擎，实现诊断逻辑、用药禁忌的实时校验；3）深度融合 PACS 影像、LIS 检验数据等多模态信息，提供病历智能续写、多学科会诊摘要生成等辅助功能。系统可使病历书写效率提升50%以上，降低错误率 40%，赋能医院运营决策与科研创新。",
      },
      {
        title: "医生智能会诊助手",
        description: "1）基于 AI 的实时分析引擎，融合多模态数据源，自动生成结构化会诊摘要；2）智能推荐引擎，结合病例特征匹配专科医生及全球罕见病案例库；3）构建跨院专家协作网络，实现疑难病例的云端联合诊疗。临床验证显示，系统可缩短会诊响应时间60%以上，提升诊断准确率42%，加速优质医疗资源纵向流动。",
      },
      {
        title: "饮食健康动态方案",
        description: "运用 AI 深度学习模型动态分析用户代谢变化趋势，融合膳食偏好、过敏原及慢性病禁忌，生成千人千面的周期性营养配餐方案，并通过食材替换建议、烹饪方式优化等功能模块，构建从方案制定到效果追踪的闭环管理体系，有效降低慢性病并发症风险，提升患者长期饮食管理依从性。",
      },
      {
        title: "医疗文献智能检索",
      ...
      {
        title: "其他 Agent",
        description: "个人健康管家助手、饮食健康成分专家、健康产品导购、健康社群维护助手、AI 心理培养师、……",
      }
    ]
  },
  {
    ...
    cases: [
      {
        title: "社群智能优化机器人",
        description: "通过深度分析社群成员互动行为数据，构建动态标签体系，实现精准用户分层。基于 AI 算法持续优化营销策略，自动化匹配触达场景，提升用户转化链路效率。",
      },
      {
        title: "智能供应链决策助手",
      ...
      {
        title: "消费趋势洞察引擎",
        description: "将行业报告数据转化为可视化洞察资产，构建结构化知识图谱。支持定制化维度钻取分析，通过 NLP 技术提炼关键驱动因素，助力企业把握细分市场机遇。",
      },
      {
        title: "AI 包装创意工作台",
        description: "基于生成对抗网络（GAN）快速迭代包装设计方案，集成消费者偏好预测模型。通过 A/B 测试模拟市场反馈，输出符合目标客群审美偏好的最优设计概念。",
      },
      {
        title: "智能视频营销工厂",
      ...
      {
        title: "小红书内容生成助手",
        description: "构建产品卖点知识库与用户评论情感图谱，生成符合平台调性的种草文案。通过热点话题融合算法，实现千人千面内容推荐，提升 UGC 互动率。",
      },
      {
        title: "公众号智能创作平台",
        description: "基于传播规律建立内容质量评估模型，提供选题策划、结构编排到金句生成的全流程辅助。集成 SEO 优化建议，提升文章打开率与分享传播系数。",
      }
    ]
  }
];
...
export const ENTERPRISE_PARTNERS_ZH = [
  {
    title: "华润啤酒",
    description: "FastGPT 赋能 AI 大模型应用探索，快速验证 AI 应用可行性、快速验证和试点的 AI 工具支持、快速接入模型能力。",
    image: "/images/enterprise/zh/p1.png",
  },
  {
    title: "启鸣达人",
    description: "FastGPT 赋能 AI 教育产品，凭借 AI + 大数据技术，依托未来学校理论引领创新，借助 AI 技术重塑教学模式，深度赋能教师成长，全方位驱动教育数字化转型，坚定迈向高质量发展。",
    image: "/images/enterprise/zh/p2.png",
  },
  {
    title: "AO 史密斯",
    description: "FastGPT 赋能 AI 落地企业内部场景最佳实践，丰富的组件库和强大的集成能力，可以满足更多企业个性化需求。",
    image: "/images/enterprise/zh/p3.png",
  },
  {
    title: "恺博座椅",
    description: "FastGPT 赋能恺博座椅落地 AI 最佳实践，AI 深度赋能, 我的职场“开挂”一天! Karry 你的贴身 AI 助理。",
