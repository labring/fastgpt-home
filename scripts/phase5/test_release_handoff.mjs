...
assert.equal(handoff.newContentItems.filter((item) => item.type === 'comparison-page').every((item) => item.sourceVersion === 'V1.2'), true);
assert.equal(handoff.sourceInputs.comparisons.pagesReadmeVersion, 'V1.2 (2026-08-08)');
