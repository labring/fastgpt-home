...
import { getBlog, getBlogBuildParams, getBlogDefaultLocale } from '@/content/blog';
...
export default async function BlogArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <BlogArticleRoute locale={locale} slug={slug} />;
}

export function generateStaticParams() {
  return getBlogBuildParams(false).map(({ slug }) => ({ slug }));
}
