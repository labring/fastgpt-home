 ...
 * capability cards, case numbers, LOGO placeholder, reading frame, closing
 * call-to-action and footer; per-page copy comes from the registry alone.
 * Case numbers reproduce the fastgpt.cn /contact wording verbatim.
 */
...
export default function AdsLandingPage({ page }: { page: AdsLandingPageData }) {
  return (
