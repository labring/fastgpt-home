  ...
  if (kind === 'zap') {
    return (
      <svg width={s} height={s} viewBox="0 0 14.62 20" style={{ flexShrink: 0 }} aria-hidden>
        <path d="M 4.655 11.705 L 0.732 11.705 C 0.22 11.705 -0.134 11.192 0.049 10.713 L 3.947 0.471 C 4.055 0.188 4.326 0 4.63 0 L 11.208 0 C 11.727 0 12.08 0.526 11.885 1.008 L 9.615 6.584 L 13.888 6.584 C 14.516 6.584 14.851 7.326 14.437 7.798 L 3.961 19.747 C 3.452 20.328 2.507 19.825 2.705 19.078 L 4.655 11.705 Z" fill="url(#case-metric-gradient)" />
      </svg>
    );
  }
  return (
    <svg width={s} height={s} viewBox="0 0 20 19.582" style={{ flexShrink: 0 }} aria-hidden>
      <path d="M 15.67 0 C 16.374 0 16.934 0.571 16.934 1.264 L 16.934 2.747 C 18.681 3.154 20 4.725 20 6.593 C 20 8.659 18.396 10.374 16.374 10.538 C 15.415 12.725 13.35 14.322 10.879 14.595 L 10.879 17.824 L 13.297 17.824 C 13.78 17.824 14.176 18.22 14.176 18.703 C 14.176 19.187 13.78 19.582 13.297 19.582 L 6.703 19.582 C 6.22 19.582 5.824 19.187 5.824 18.703 C 5.824 18.22 6.22 17.824 6.703 17.824 L 9.121 17.824 L 9.121 14.564 C 6.766 14.217 4.806 12.663 3.879 10.549 C 1.736 10.506 0 8.747 0 6.593 C 0 4.637 1.439 3 3.308 2.692 L 3.308 1.264 C 3.308 0.56 3.879 0 4.571 0 Z M 10.527 3.67 C 10.231 3.088 9.791 3.088 9.549 3.67 L 8.769 5.286 L 7.011 5.528 C 6.418 5.626 6.275 6.066 6.714 6.505 L 7.989 7.824 L 7.692 9.681 C 7.593 10.308 7.934 10.56 8.473 10.264 L 10.044 9.385 L 11.615 10.319 C 12.154 10.615 12.494 10.374 12.396 9.736 L 12.099 7.879 L 13.374 6.56 C 13.813 6.121 13.67 5.681 13.066 5.571 L 11.308 5.33 Z M 3.308 4.494 C 2.418 4.769 1.758 5.604 1.758 6.593 C 1.758 7.604 2.44 8.462 3.363 8.703 C 3.33 8.45 3.308 8.198 3.308 7.934 Z M 16.934 7.945 C 16.934 8.176 16.912 8.396 16.89 8.626 C 17.681 8.297 18.242 7.506 18.242 6.604 C 18.243 5.734 17.73 4.945 16.934 4.593 Z" fill="url(#case-metric-gradient)" />
    </svg>
  );
}
