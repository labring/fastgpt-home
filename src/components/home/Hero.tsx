...
const blobs = [
  { w: 620, h: 620, left: '-5%', top: -60, color: '#FBD0DF', x: [0, 180, 240, 80, -40, 0], y: [0, 40, -30, 60, 15, 0], s: [1, 1.15, 0.9, 1.1, 0.95, 1], dur: 14 },
  { w: 660, h: 660, left: '10%', top: -80, color: '#D4D6FF', x: [0, -160, -220, -60, 40, 0], y: [0, 30, 80, -25, 55, 0], s: [1, 0.9, 1.2, 0.95, 1.1, 1], dur: 16 },
  { w: 560, h: 560, left: '20%', top: -20, color: '#C6DBFF', x: [0, 140, -160, 100, -60, 0], y: [0, -60, -15, 45, -30, 0], s: [1, 1.1, 0.85, 1.2, 0.9, 1], dur: 18, delay: 1.5 },
  { w: 500, h: 500, left: '30%', top: 20, color: '#EFD6FF', x: [0, -100, 160, -40, 100, 0], y: [0, 40, -50, 70, -15, 0], s: [1, 0.95, 1.15, 0.9, 1.1, 1], dur: 20, delay: 3 },
];
