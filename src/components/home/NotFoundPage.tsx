...
function getLang(pathname: string) {
  ...
  return lang === 'zh' || lang === 'ja' || lang === 'en' ? lang : 'en';
}
...
export default function NotFoundPage() {
  ...
  const docsUrl = lang === 'zh'
    ? 'https://doc.fastgpt.cn/docs/introduction'
    : 'https://doc.fastgpt.io/docs/introduction';
  const startUrl = process.env.NEXT_PUBLIC_USER_URL || (lang === 'zh'
  ...
  return (
    <div className="home min-h-[100svh] overflow-hidden bg-white text-ink">
      <HomeThemeFix />
      <div className="mx-auto flex min-h-[100svh] w-full max-w-[1280px] flex-col px-4 py-6 md:px-8">
