---
title: 解决FastGPT中非JSON格式API与聊天上下文控制异常问题
slug: /zh/troubleshoot/fastgpt-api-json-context-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1084
source_type: GitHub issue
---

# 解决FastGPT中非JSON格式API与聊天上下文控制异常问题
...
> 用户反馈存在两个异常问题：一是部分公开API未使用application/json格式传输数据，涉及代码路径为packages/service/core/workflow/dispatch/tools/http468.ts第91行；二是在问题分类中设置聊天记录条数为1时，无法正常控制对话上下文。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1084)
