---
title: 解决FastGPT API返回转义字符串无法直接调用的问题
slug: /zh/troubleshoot/fastgpt-api-json-escaping-fix
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4258
source_type: GitHub issue
---

# 解决FastGPT API返回转义字符串无法直接调用的问题
...
> 调用FastGPT的API后，返回的content字段为带转义的JSON字符串，例如示例中的`"content": "[\n {\n \"公司\": \"兴业银行023－038号\",\n \"公司 ID\": \"无\",\n \"是否为内部公司\": false\n },\n ...\n]"`，该字符串内部的换行符和双引号均被转义，其他系统无法直接解析，需要额外进行转义处理才能使用。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4258)
