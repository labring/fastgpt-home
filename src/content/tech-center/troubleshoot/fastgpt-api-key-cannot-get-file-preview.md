---
title: 解决FastGPT API-key无法获取知识库文件预览地址问题
slug: /zh/troubleshoot/fastgpt-api-key-cannot-get-file-preview
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1190
source_type: GitHub issue
---

# 解决FastGPT API-key无法获取知识库文件预览地址问题
...
> FastGPT 4.7私有部署版本中，上传的知识库文件无法通过创建的API-key获取在线预览地址。使用网页端查看源文件的接口时，该API-key的校验无法通过，用户提供的相关截图显示接口返回校验失败的结果。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1190)
