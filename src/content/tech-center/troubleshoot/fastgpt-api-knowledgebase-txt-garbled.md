---
title: 解决FastGPT私有部署API知识库txt文件上传乱码问题
slug: /zh/troubleshoot/fastgpt-api-knowledgebase-txt-garbled
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4383
source_type: GitHub issue
---

# 解决FastGPT私有部署API知识库txt文件上传乱码问题
...
> FastGPT 4.9.1-fix2私有部署版本中，使用API知识库上传txt文件时会出现内容乱码。点击查看该文件的原始内容，得到的文件同样存在乱码问题。使用普通文件上传功能上传相同的txt文件，解析结果显示正常，与原文件内容一致。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4383)
