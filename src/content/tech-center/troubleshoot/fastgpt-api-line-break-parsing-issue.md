---
title: 解决FastGPT调用/api/v1/chat/completions接口的换行符识别异常问题
slug: /zh/troubleshoot/fastgpt-api-line-break-parsing-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1671
source_type: GitHub issue
---

# 解决FastGPT调用/api/v1/chat/completions接口的换行符识别异常问题
...
> 调用FastGPT的`/api/v1/chat/completions`接口时，传入的`variables.prompt`参数包含换行符（如示例参数`"规则：\n1.第一部分 \n2.第二部分"`），接口无法正确识别并处理该换行符，导致参数解析或返回结果不符合预期。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1671)
