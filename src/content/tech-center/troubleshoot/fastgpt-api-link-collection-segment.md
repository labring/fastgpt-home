---
title: 解决FastGPT通过API创建链接集合时的文件自动分段异常问题
slug: /zh/troubleshoot/fastgpt-api-link-collection-segment
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/946
source_type: GitHub issue
---

# 解决FastGPT通过API创建链接集合时的文件自动分段异常问题
...
> 通过FastGPT的“创建链接集合”API接口调用时，传入TXT格式文件的链接可正常自动分段，传入PDF、Word等格式文件的链接无法自动分段。用户使用的请求参数示例如下： ```json { "trainingType": "chunk", "chunkSize": 512, "link": "https://zhixiaologo.oss-cn-hzfinance.aliyuncs.com/2024/3/26051709519553612.pdf", "datasetId
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/946)
