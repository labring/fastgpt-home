---
title: FastGPT 4.8.20私有部署版API指定知识库的解决方法
slug: /zh/troubleshoot/fastgpt-api-specify-knowledge-base
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3700
source_type: GitHub issue
---

# FastGPT 4.8.20私有部署版API指定知识库的解决方法
...
> 用户通过Docker部署FastGPT 4.8.20私有部署版，Web界面可正常与指定知识库对话，但调用官方提供的聊天API时，文档示例未包含指定知识库的配置，无法通过API关联目标知识库进行对话。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3700)
