---
title: 解决FastGPT API调用中stream参数影响知识库引用的问题
slug: /zh/troubleshoot/fastgpt-api-stream-reference-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/5202
source_type: GitHub issue
---

# 解决FastGPT API调用中stream参数影响知识库引用的问题
...
> 用户基于知识库搭建问答机器人后，通过API调用时发现以下情况：当将stream参数设为False时，AI的回答未包含知识库的引用标记；将stream设为True时则正常包含引用标记。用户的系统提示词已要求AI带上引用标记，同时其Python调用代码中设置了detail: False，且疑问该调用是否实际使用了知识库知识。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/5202)
