---
title: 解决FastGPT HTTP API上传文件集合的调用报错问题
slug: /zh/troubleshoot/fastgpt-api-upload-collection-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3458
source_type: GitHub issue
---

# 解决FastGPT HTTP API上传文件集合的调用报错问题
...
> 使用FastGPT的HTTP API上传文件集合时出现调用错误。用户编写的POST请求代码向`http://ip和端口/api/core/dataset/collection/create/localFile`发起请求，程序触发错误并打印出非预期的响应内容，未成功创建目标文件集合。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3458)
