---
title: 解决FastGPT应用发布接口的节点参数不完整报错问题
slug: /zh/troubleshoot/fastgpt-app-publish-params-incomplete
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2945
source_type: GitHub issue
---

# 解决FastGPT应用发布接口的节点参数不完整报错问题
...
> 调用`api/core/app/version/publish`接口，参数`appId=6710656fad1b40b46c7988fa`，携带的`nodes`参数中，`flowNodeType`为`chatNode`的AI对话节点的`inputs`数组未完整传输，JSON截断至`"key": "aiChatQuoteRole",`后结束。接口返回异常，具体报错需按实际环境确认。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2945)
