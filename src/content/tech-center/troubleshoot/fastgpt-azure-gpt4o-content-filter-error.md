---
title: 解决FastGPT中Azure GPT-4o流式内容过滤相关报错问题
slug: /zh/troubleshoot/fastgpt-azure-gpt4o-content-filter-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2440
source_type: GitHub issue
---

# 解决FastGPT中Azure GPT-4o流式内容过滤相关报错问题
...
> 私有部署4.8.9版本的FastGPT，调用Azure GPT-4o流式接口时存在两种报错场景： 1. 当请求直接返回400错误时，FastGPT报错提示符合预期； 2. 当请求建立流式连接后，通过event形式返回内容过滤错误时，FastGPT仅提示"LLM model response empty"。 其中敏感词"泡馆"会触发Azure GPT-4o的内容过滤，且该情况不会在GPT-4-Turbo中出现。上游代理会原样传递Azure的响应内容。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2440)
