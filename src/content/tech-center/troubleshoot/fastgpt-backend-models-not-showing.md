---
title: 解决FastGPT后台无法显示指定模型的问题
slug: /zh/troubleshoot/fastgpt-backend-models-not-showing
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1460
source_type: GitHub issue
---

# 解决FastGPT后台无法显示指定模型的问题
...
> 用户反馈在FastGPT后台的模型选择界面无法看到可用的AI模型，但在简单模式中可以正常查看所有模型。用户同时提供了后台模型列表异常、简单模式正常显示模型的两张截图。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1460)
