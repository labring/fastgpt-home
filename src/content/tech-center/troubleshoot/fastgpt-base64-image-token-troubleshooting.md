---
title: 解决FastGPT base64传参调用模型时token占用过小的问题
slug: /zh/troubleshoot/fastgpt-base64-image-token-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4473
source_type: GitHub issue
---

# 解决FastGPT base64传参调用模型时token占用过小的问题
...
> 用户通过FastGPT的API接口以base64格式传入图片参数，请求体格式示例为： ```json [{"type":"image_url","image_url":{"url":"data:image/jpeg;base64,[base64数据]"},"image_name":"03df3869831efbaf45b1cb3133540000.png"}] ``` 实际传入的base64数据量较大，但调用后平台显示的token占用量远低于预期。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4473)
