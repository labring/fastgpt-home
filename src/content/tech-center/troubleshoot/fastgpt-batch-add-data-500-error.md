---
title: 解决FastGPT集合批量添加数据接口报500错误问题
slug: /zh/troubleshoot/fastgpt-batch-add-data-500-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1494
source_type: GitHub issue
---

# 解决FastGPT集合批量添加数据接口报500错误问题
...
> 使用FastGPT为集合批量添加数据时，接口返回500错误。此前该功能可正常使用，API可正常记录接口调用时间，但无法成功上传文本数据至对应集合。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1494)
