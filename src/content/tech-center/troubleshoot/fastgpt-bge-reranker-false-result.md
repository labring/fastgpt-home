---
title: 解决FastGPT私有部署版中bge reranker重排结果为false的问题
slug: /zh/troubleshoot/fastgpt-bge-reranker-false-result
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1502
source_type: GitHub issue
---

# 解决FastGPT私有部署版中bge reranker重排结果为false的问题
...
> 用户在FastGPT私有部署v4.8版本中接入bge reranker后，前期测试正常，但调用知识库时，运行日志提示"重排结果"为false。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1502)
