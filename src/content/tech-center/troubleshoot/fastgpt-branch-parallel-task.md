---
title: 解决FastGPT分支流程无法并行执行批量任务的问题
slug: /zh/troubleshoot/fastgpt-branch-parallel-task
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2373
source_type: GitHub issue
---

# 解决FastGPT分支流程无法并行执行批量任务的问题
...
> 在FastGPT 4.8.9私有部署版本中，分支流程会按照预设的层级顺序执行任务。用户测试发现，当生成13个510300ETF相关的查询子问题，包括管理人、基金经理、成立日期等内容后，系统会依次获取每个问题的答案，无法并行执行，导致批量任务处理效率较低。用户希望所有子问题的答案可以并行获取，待全部结果返回后再统一进行答案总结。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2373)
