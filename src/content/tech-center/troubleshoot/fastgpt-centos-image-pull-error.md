---
title: 解决CentOS部署FastGPT私有版时镜像拉取连接重置问题
slug: /zh/troubleshoot/fastgpt-centos-image-pull-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3884
source_type: GitHub issue
---

# 解决CentOS部署FastGPT私有版时镜像拉取连接重置问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 v4.8.22；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 在CentOS系统上通过docker-compose部署FastGPT私有版本时，用户按照官方流程创建fastgpt目录、下载配置文件与docker-compose配置后，执行`docker-compose up -d`命令启动容器，出现镜像拉取失败报错。完整报错信息为： ``` Pulling sandbox (ghcr.io/labring/fastgpt-sandbox:v4.8.22)... ERROR: Head "https://ghcr.io/v2/labrin
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3884)
