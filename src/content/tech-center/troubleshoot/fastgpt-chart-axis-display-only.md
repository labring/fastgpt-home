---
title: FastGPT图表插件输入数据正确却仅显示横纵坐标的排错指南
slug: /zh/troubleshoot/fastgpt-chart-axis-display-only
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3217
source_type: GitHub issue
---

# FastGPT图表插件输入数据正确却仅显示横纵坐标的排错指南
...
> 用户使用FastGPT的图表插件时，输入的数据确认正确，但无法生成完整图表，仅显示横坐标轴与纵坐标轴，无对应图表主体内容，附带的三张截图可佐证该界面表现。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3217)
