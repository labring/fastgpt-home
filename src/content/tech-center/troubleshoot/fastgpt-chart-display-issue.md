---
title: 解决FastGPT调用工具后图表无法正常生成的问题
slug: /zh/troubleshoot/fastgpt-chart-display-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3170
source_type: GitHub issue
---

# 解决FastGPT调用工具后图表无法正常生成的问题
...
> 用户在FastGPT中配置工作流，使用qwen-72b模型调用基础图表插件，输入某省电信1-6月主营收入相关数据请求生成折线图。存在两类异常表现：一是系统日志显示调用了工具，但最终无法生成目标图表；二是工作流未触发工具调用流程，无法得到预期结果。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3170)
