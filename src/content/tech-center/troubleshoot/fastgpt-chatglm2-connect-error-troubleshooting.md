---
title: FastGPT接入本地ChatGLM2模型时出现连接错误的排错方法
slug: /zh/troubleshoot/fastgpt-chatglm2-connect-error-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/727
source_type: GitHub issue
---

# FastGPT接入本地ChatGLM2模型时出现连接错误的排错方法
...
> 用户在Docker环境部署FastGPT，通过OneAPI接入本地ChatGLM2-6B模型。用户按照官方文档教程，使用openai_api.py将模型容器的端口开放为6006，在使用FastGPT发起对话时，出现了connect error报错。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/727)
