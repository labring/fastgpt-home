---
title: 解决FastGPT部署ChatGLM3时的prompt格式适配问题
slug: /zh/troubleshoot/fastgpt-chatglm3-prompt-fix
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/437
source_type: GitHub issue
---

# 解决FastGPT部署ChatGLM3时的prompt格式适配问题
...
> 在FastGPT中部署或调用ChatGLM3模型时，使用官方指定的<|system|>、<|user|>、<|assistant|>格式的对话prompt，无法正常获取模型回复，或出现格式不兼容相关提示。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/437)
