---
title: 解决FastGPT 4.7私有部署版本chatglm3-6b工具调用不生效问题
slug: /zh/troubleshoot/fastgpt-chatglm3-tool-call-fix
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1514
source_type: GitHub issue
---

# 解决FastGPT 4.7私有部署版本chatglm3-6b工具调用不生效问题
...
> 私有部署的FastGPT 4.7版本中，使用chatglm3-6b模型时工具调用功能失效。通过调试窗口可观察到模型已正确判断需要调用对应工具，但系统未实际执行工具调用并返回对应内容，无法正常获取工具返回结果后整合输出。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1514)
