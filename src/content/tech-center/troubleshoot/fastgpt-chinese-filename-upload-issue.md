---
title: 解决FastGPT接口上传本地文件时中文文件名乱码问题
slug: /zh/troubleshoot/fastgpt-chinese-filename-upload-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2282
source_type: GitHub issue
---

# 解决FastGPT接口上传本地文件时中文文件名乱码问题
...
> 使用FastGPT的`/api/core/dataset/collection/create/localFile`接口上传含中文名称的本地文件时，服务端接收的文件名出现乱码。用户已确认本地文件名为UTF-8编码，但上传后文件名仍显示乱码。示例请求包含curl命令与Java OkHttp实现代码，其中Java代码中已尝试对文件名做UTF-8编码处理，但问题仍未解决。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2282)
