---
title: 解决FastGPT私有部署后代码调用接口超时的问题
slug: /zh/troubleshoot/fastgpt-code-timeout-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/550
source_type: GitHub issue
---

# 解决FastGPT私有部署后代码调用接口超时的问题
...
> 使用docker-compose方式私有部署FastGPT后，在高级编排模块配置的HTTP POST接口调用逻辑，通过浏览器调试窗口可正常获取响应；但将该接口调用逻辑封装为自有代码后发起请求时，会提示fastgpt timeout报错。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/550)
