---
title: 解决FastGPT用户调用Cohere格式rerank API接口的相关配置问题
slug: /zh/troubleshoot/fastgpt-cohere-rerank-api
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/998
source_type: GitHub issue
---

# 解决FastGPT用户调用Cohere格式rerank API接口的相关配置问题
...
> 用户在FastGPT中使用知识库RAG重排功能时，需要调用符合Cohere格式的rerank API接口，但现有接口未兼容Cohere官方的rerank协议规范。无法直接使用Cohere SDK发起标准的rerank调用，无法匹配示例中的co.rerank调用逻辑与返回结构，导致无法快速复用现有Cohere格式的rerank代码。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/998)
