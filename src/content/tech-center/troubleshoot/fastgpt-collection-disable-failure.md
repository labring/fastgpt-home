---
title: 解决FastGPT私有部署版集合禁用功能失效的问题
slug: /zh/troubleshoot/fastgpt-collection-disable-failure
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2132
source_type: GitHub issue
---

# 解决FastGPT私有部署版集合禁用功能失效的问题
...
> 用户在GitHub issue中反馈，其使用GitHub拉取的v4.8.7私有部署版FastGPT源码构建镜像后，尝试通过系统功能禁用单个知识库集合，但禁用操作未生效，知识库仍可正常检索被禁用集合内的文档。用户同时提供了集合开关开启与关闭状态的日志截图作为佐证。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2132)
