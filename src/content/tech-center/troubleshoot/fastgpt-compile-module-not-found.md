---
title: 解决FastGPT编译时出现模块无法找到的报错问题
slug: /zh/troubleshoot/fastgpt-compile-module-not-found
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4178
source_type: GitHub issue
---

# 解决FastGPT编译时出现模块无法找到的报错问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 148.0；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 执行FastGPT编译流程时，出现编译失败报错，完整报错信息如下： ``` 148.0 Failed to compile. 148.0 148.0 ./src/pages/api/core/app/version/list.test.ts 148.0 Module not found: Can't resolve '@test/datas/users' 148.0 148.0 https://nextjs.org/docs/messages/module-not-found
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4178)
