---
title: 解决FastGPT 4.7私有部署版本的Connection error连接报错问题
slug: /zh/troubleshoot/fastgpt-connection-error-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1351
source_type: GitHub issue
---

# 解决FastGPT 4.7私有部署版本的Connection error连接报错问题
...
> 用户在使用FastGPT 4.7私有部署版本时，进行对话或接口测试操作时会触发连接报错，报错信息为`message: 'Connection error.'`，对应的日志栈包含`at af.makeRequest`、`at async Object.x [as chatNode]`等服务端代码调用记录。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1351)
