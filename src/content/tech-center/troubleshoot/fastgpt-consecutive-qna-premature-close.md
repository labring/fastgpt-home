---
title: 解决FastGPT连续知识库问答出现Premature close报错问题
slug: /zh/troubleshoot/fastgpt-consecutive-qna-premature-close
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/953
source_type: GitHub issue
---

# 解决FastGPT连续知识库问答出现Premature close报错问题
...
> 私有部署版本的FastGPT，连续执行知识库问答时，第一次问答可正常完成，第二次问答会触发报错。报错文本包含`Premature close`，错误堆栈显示异常发生在Next.js服务端代码的流处理逻辑中，同时FastGPT容器日志会打印`[ERROR] sse error: Premature close`的错误信息。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/953)
