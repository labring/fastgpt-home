---
title: 解决FastGPT私有部署版本CSV文件索引卡住的问题
slug: /zh/troubleshoot/fastgpt-csv-index-stuck-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2790
source_type: GitHub issue
---

# 解决FastGPT私有部署版本CSV文件索引卡住的问题
...
> 使用fastgpt:v4.8.9私有部署版本时，部分CSV文件在上传至知识库后长时间卡在索引状态。用户删除部分卡住的CSV文件并重新上传后，部分文件可正常加载，但仍有部分文件持续处于索引中。测试环境使用相同镜像与CSV文件时，配置qwenv2-32k作为文件处理模型可正常加载所有内容；部署环境更换为glm-4-plus后，one-api日志未出现相关大模型请求记录。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2790)
