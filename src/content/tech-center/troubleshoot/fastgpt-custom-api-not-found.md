---
title: 解决FastGPT配置自定义API地址后返回Not Found错误的问题
slug: /zh/troubleshoot/fastgpt-custom-api-not-found
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/374
source_type: GitHub issue
---

# 解决FastGPT配置自定义API地址后返回Not Found错误的问题
...
> 1. 本地Docker部署FastGPT，使用原生OpenAI地址和Key可正常发起对话。 2. 本地部署自定义API服务，使用Notebook或Postman访问其`/v1/chat/completions`端点，可正常完成对话请求。 3. 替换FastGPT的`docker-compose.yml`中的`OPENAI_BASE_URL`和`CHAT_API_KEY`为自定义API服务的地址和令牌后，点击FastGPT的聊天页面发起对话，提示错误“Not Found”。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/374)
