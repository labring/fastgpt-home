---
title: 解决FastGPT自定义代码调用时首次对话返回空event的问题
slug: /zh/troubleshoot/fastgpt-custom-call-empty-event
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1138
source_type: GitHub issue
---

# 解决FastGPT自定义代码调用时首次对话返回空event的问题
...
> 用户在NextWeb中可正常使用目标模型，但通过自定义代码调用FastGPT时出现异常：首次对话返回的第一条event为空消息，第二条触发报错；第二次对话可正常获得正确回答。用户已确认自身API Key可正常使用。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1138)
