---
title: 解决FastGPT通过自定义渠道调用时的核心聊天API报错问题
slug: /zh/troubleshoot/fastgpt-custom-channel-api-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/847
source_type: GitHub issue
---

# 解决FastGPT通过自定义渠道调用时的核心聊天API报错问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 4.6.8；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 使用FastGPT 4.6.8版本时，直接配置FastGPT部署的API地址和密钥可正常使用。但通过自定义渠道调用时，FastGPT端会输出报错日志： ``` [ERROR] 2024-02-13 13:57:59 sse error: core.chat.Chat API is error or undefined { message: 'core.chat.Chat API is error or undefined', stack: undefined } ```
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/847)
