---
title: 解决FastGPT配置自定义模型后页面未显示的问题
slug: /zh/troubleshoot/fastgpt-custom-model-not-displayed
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/565
source_type: GitHub issue
---

# 解决FastGPT配置自定义模型后页面未显示的问题
...
> 用户在本地部署FastGPT私有版本，启动本地chatglm3模型的OpenAI兼容服务，通过one api进行代理，随后在config.json中添加该模型的配置项，执行docker restart命令重启FastGPT容器。但在Web页面的模型选择界面中，并未看到chatglm3的模型选项。此外，当用户删除config.json中所有GPT相关的配置，仅保留chatglm3的模型描述时，Web页面依然会显示GPT相关的模型选项。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/565)
