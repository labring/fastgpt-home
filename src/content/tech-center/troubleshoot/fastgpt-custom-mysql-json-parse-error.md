---
title: 解决FastGPT自定义MySQL数据源执行SQL时的JSON解析报错问题
slug: /zh/troubleshoot/fastgpt-custom-mysql-json-parse-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4081
source_type: GitHub issue
---

# 解决FastGPT自定义MySQL数据源执行SQL时的JSON解析报错问题
...
> 私有部署FastGPT时，使用自定义MySQL数据源执行SQL查询，Docker日志中出现`Invalid JSON body`报错，报错内容包含带换行符的SQL语句片段，且提供的SQL语句存在未完成的截断（如示例中`as '下午状`未闭合完整）。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4081)
