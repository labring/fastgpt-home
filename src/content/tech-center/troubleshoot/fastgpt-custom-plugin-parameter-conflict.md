---
title: 解决FastGPT自定义插件间调用的参数匹配冲突问题
slug: /zh/troubleshoot/fastgpt-custom-plugin-parameter-conflict
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2575
source_type: GitHub issue
---

# 解决FastGPT自定义插件间调用的参数匹配冲突问题
...
> 在FastGPT私有部署版本中，自定义插件A调用另一个插件B时，若插件B包含文本输入框类型的参数，且自定义插件A的输入变量中恰好存在与插件B参数同名的变量，会导致配置操作不便。当前配置界面未提供类似AI组件的参数绑定切换选项，无法灵活处理此类同名参数的匹配问题。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2575)
