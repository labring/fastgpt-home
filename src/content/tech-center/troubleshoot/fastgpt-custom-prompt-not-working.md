---
title: 解决FastGPT私有部署版v4.7自定义prompt不生效的问题
slug: /zh/troubleshoot/fastgpt-custom-prompt-not-working
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1283
source_type: GitHub issue
---

# 解决FastGPT私有部署版v4.7自定义prompt不生效的问题
...
> 用户使用FastGPT私有部署版v4.7，配置自定义prompt以实现师生问答场景：当学生输入特定分类的问题时，自动回复关联知识库的内容，但自定义prompt未生效，系统未按设定调用知识库内容进行回复。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1283)
