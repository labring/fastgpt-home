---
title: 解决FastGPT自定义工具变量获取AI传入值为空的问题
slug: /zh/troubleshoot/fastgpt-custom-tool-empty-variable
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/5337
source_type: GitHub issue
---

# 解决FastGPT自定义工具变量获取AI传入值为空的问题
...
> 用户反馈在FastGPT的自定义工具配置中，尝试获取AI传入的变量时，最终拿到的结果始终为空。从其提供的工作流复现配置来看，系统配置节点（nodeId: userGuide）的variables参数值为空数组，工作流启动节点的配置信息存在截断。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/5337)
