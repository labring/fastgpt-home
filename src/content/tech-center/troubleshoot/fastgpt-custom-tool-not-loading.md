---
title: 解决FastGPT自定义系统工具上传后页面不加载的问题
slug: /zh/troubleshoot/fastgpt-custom-tool-not-loading
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/5742
source_type: GitHub issue
---

# 解决FastGPT自定义系统工具上传后页面不加载的问题
...
> 用户按教程开发自定义系统工具，上传到FastGPT的“系统工具”页面时显示上传成功，但页面未加载刚上传的插件，且/api/plugin/tool/upload/confirmUpload请求报错。FastGPT报错日志显示`SyntaxError: Unexpected token '<', "<!DOCTYPE "... is not valid JSON`，fastgpt-plugin报错日志显示`[Warn] 2025-10-10 02:16:50: Uncaught
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/5742)
