---
title: 解决FastGPT接入自定义TTS模型的语音播放异常问题
slug: /zh/troubleshoot/fastgpt-custom-tts-playback-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1984
source_type: GitHub issue
---

# 解决FastGPT接入自定义TTS模型的语音播放异常问题
...
> 通过API方式接入自定义TTS模型后，存在两处语音播放异常问题。一是试听功能无法正常播放声音，首次点击试听会生成语音但无声音输出，再次点击该模型后既无法生成语音也无声音；二是对话场景中，语音播放需要点击两次，第一次生成语音，第二次才能听到声音。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1984)
