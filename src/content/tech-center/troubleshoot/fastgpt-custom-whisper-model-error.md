---
title: 解决FastGPT语音输入无法使用自定义whisper模型的问题
slug: /zh/troubleshoot/fastgpt-custom-whisper-model-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1139
source_type: GitHub issue
---

# 解决FastGPT语音输入无法使用自定义whisper模型的问题
...
> 该问题出现在FastGPT V4.7私有部署版本中。用户在config.json中配置了自定义whisper模型： ```json "whisperModel": { "model": "Belle-distilwhisper-large-v2-zh", "name": "Belle-distilwhisper-large-v2-zh", "charsPointsPrice": 0 } ``` 但使用语音输入时仅可使用whisper-1模型，配置的自定义模型无法生效。同时on
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1139)
