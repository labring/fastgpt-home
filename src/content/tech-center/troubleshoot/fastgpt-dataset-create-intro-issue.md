---
title: 解决FastGPT通过API创建知识库时intro参数不生效的问题
slug: /zh/troubleshoot/fastgpt-dataset-create-intro-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2698
source_type: GitHub issue
---

# 解决FastGPT通过API创建知识库时intro参数不生效的问题
...
> 使用POST请求调用`/api/core/dataset/create`接口创建知识库时，在请求体中传入了`intro`参数配置知识库介绍，但最终创建的知识库未应用该参数设置的介绍内容。例如按照示例请求执行后，生成的知识库`知识库001`未显示`用程序创建的知识库1`的介绍。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2698)
