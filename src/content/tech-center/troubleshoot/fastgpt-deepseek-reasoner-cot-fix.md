---
title: 解决deepseek-reasoner模型不同部署场景的CoT解析适配问题
slug: /zh/troubleshoot/fastgpt-deepseek-reasoner-cot-fix
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3733
source_type: GitHub issue
---

# 解决deepseek-reasoner模型不同部署场景的CoT解析适配问题
...
> 使用deepseek-reasoner模型时，不同部署方式返回的思考过程（CoT）格式不一致。部分场景下模型通过reasoning_content参数传递CoT信息，自行部署或部分其他服务商部署的模型则通过<think></think>标签包裹CoT内容。FastGPT当前的输出思考功能仅支持读取reasoning_content参数获取CoT信息，无法解析<think></think>标签包裹的内容。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3733)
