---
title: 解决FastGPT部署后分组default下无可用模型渠道的问题
slug: /zh/troubleshoot/fastgpt-default-model-unavailable-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2455
source_type: GitHub issue
---

# 解决FastGPT部署后分组default下无可用模型渠道的问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 V4.8.6；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 私有部署FastGPT V4.8.6版本时，调用通过OneAPI测试正常的模型时，系统返回报错"undefined 当前分组 default 下对于模型 xxxx 无可用渠道"；使用本地Qwen2模型可以正常完成问答流程。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2455)
