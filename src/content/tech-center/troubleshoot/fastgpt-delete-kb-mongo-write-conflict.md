---
title: FastGPT删除知识库时MongoDB写冲突报错的排错指南
slug: /zh/troubleshoot/fastgpt-delete-kb-mongo-write-conflict
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/984
source_type: GitHub issue
---

# FastGPT删除知识库时MongoDB写冲突报错的排错指南
...
> 私有部署FastGPT时，执行删除知识库操作会触发报错。查看系统日志可发现如下错误信息：`[ERROR] 2024-03-12 13:23:12 response error: WriteConflict error: this operation conflicted with another operation. Please retry your operation or multi-document transaction.`，完整报错栈包含MongoServerEr
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/984)
