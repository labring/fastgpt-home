---
title: 解决FastGPT云端部署Nginx与Cloudflare SSL证书的配置问题
slug: /zh/troubleshoot/fastgpt-deploy-nginx-ssl-config
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2885
source_type: GitHub issue
---

# 解决FastGPT云端部署Nginx与Cloudflare SSL证书的配置问题
...
> 用户在进行FastGPT云端部署时，计划在docker-compose-milvus.yaml中添加Nginx容器，使用Cloudflare Original Certificates配置SSL证书，编写了对应的docker-compose配置与nginx.conf配置文件，无法确认配置的正确性，同时希望获取云端应用的Nginx配置指导。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2885)
