---
title: 解决FastGPT私有部署版详情页知识库搜索无权操作数据集问题
slug: /zh/troubleshoot/fastgpt-detail-page-unauth-dataset-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4323
source_type: GitHub issue
---

# 解决FastGPT私有部署版详情页知识库搜索无权操作数据集问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 4.9.1-fix2；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 用户使用私有部署版FastGPT 4.9.1-fix2，在/app/detail页面点击“查看详情”按钮进入详情页后，点击其中的知识库节点，页面弹出“无权操作该数据集”的提示。通过浏览器网络面板查看接口调用，发现请求`/api/core/chat/quote/getQuote`时返回报错：`{"code":501005,"statusText":"unAuthDatasetCollection","message":"core.dataset.error.unAuthData
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4323)
