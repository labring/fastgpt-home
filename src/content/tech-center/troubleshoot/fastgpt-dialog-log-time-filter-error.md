---
title: 解决FastGPT对话日志时间范围筛选异常问题
slug: /zh/troubleshoot/fastgpt-dialog-log-time-filter-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4015
source_type: GitHub issue
---

# 解决FastGPT对话日志时间范围筛选异常问题
...
> 用户在FastGPT公有云版本的【对话日志】页面选择时间范围筛选时，筛选出的对话记录未匹配所选时间范围。仅昨日的时间范围筛选结果正确，提前数日的范围（例如当前日期为2025-03-06时，选择2025-02-28至2025-03-01）筛选结果异常。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4015)
