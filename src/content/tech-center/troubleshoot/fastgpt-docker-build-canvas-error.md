---
title: 解决FastGPT私有部署docker build时canvas包编译报错问题
slug: /zh/troubleshoot/fastgpt-docker-build-canvas-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1160
source_type: GitHub issue
---

# 解决FastGPT私有部署docker build时canvas包编译报错问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 4.7、2.11.2、v2.11.2、v2.11.2-node；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 执行`docker build -t fastgpt --build-arg name=app .`命令进行FastGPT 4.7版本私有部署的docker镜像构建时，出现canvas@2.11.2包安装报错。完整报错信息包含：尝试下载`https://github.com/Automattic/node-canvas/releases/download/v2.11.2/canvas-v2.11.2-node-v108-linux-musl-arm64.tar.gz`返回40
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1160)
