---
title: 解决FastGPT 4.8.4版本docker compose拉取镜像停滞问题
slug: /zh/troubleshoot/fastgpt-docker-compose-pull-stuck
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1973
source_type: GitHub issue
---

# 解决FastGPT 4.8.4版本docker compose拉取镜像停滞问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 4.8.4；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 用户在FastGPT 4.8.4本地环境执行`docker compose pull`命令时，终端输出警告`WARN[0000] /root/wechat/docker-compose.yml: 'version' is obsolete`，拉取chatgpt-on-wechat镜像的过程中，多个镜像层如76956b537f14、f75f1b8a4051等停滞在`Pulling fs layer`步骤，持续超过6秒未推进进度，附带两张拉取进度截图。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1973)
