---
title: 解决Docker Compose部署FastGPT新建应用超时问题
slug: /zh/troubleshoot/fastgpt-docker-compose-timeout-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1039
source_type: GitHub issue
---

# 解决Docker Compose部署FastGPT新建应用超时问题
...
> Docker Compose部署的FastGPT，在新建应用时弹出`timeout of 60000ms exceeded`报错，可正常登录FastGPT平台。执行`docker logs fastgpt`未查询到错误日志，但启动过程中存在两个未明确影响的报错。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1039)
