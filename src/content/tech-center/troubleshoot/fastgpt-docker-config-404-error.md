---
title: 解决FastGPT私有部署新增大模型配置后openapi测试报404的问题
slug: /zh/troubleshoot/fastgpt-docker-config-404-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3419
source_type: GitHub issue
---

# 解决FastGPT私有部署新增大模型配置后openapi测试报404的问题
...
> 使用docker私有化部署FastGPT v4.7版本时，在config.json中完成新增大模型配置后，调用openapi接口测试返回404错误，且无相关报错日志。同时FastGPT应用端也出现对应报错提示。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3419)
