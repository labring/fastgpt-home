---
title: 解决Docker部署FastGPT时账号密码重复配置的问题
slug: /zh/troubleshoot/fastgpt-docker-env-credential-management
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/5761
source_type: GitHub issue
---

# 解决Docker部署FastGPT时账号密码重复配置的问题
...
> 使用docker-compose部署FastGPT时，修改数据库、缓存、存储等服务的账号密码需要重复操作。既要修改对应服务的环境变量配置，也要修改引用该配置的共享配置块，容易出现配置与实际使用不一致的情况，引发服务启动失败或功能异常。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/5761)
