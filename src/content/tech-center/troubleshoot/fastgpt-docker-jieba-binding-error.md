---
title: 解决Docker部署FastGPT时jieba原生绑定加载失败的问题
slug: /zh/troubleshoot/fastgpt-docker-jieba-binding-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1453
source_type: GitHub issue
---

# 解决Docker部署FastGPT时jieba原生绑定加载失败的问题
...
> Docker部署FastGPT时，打开登录页出现报错且无法完成登录。该问题仅在Docker环境中出现，使用pnpm dev本地开发时运行正常。报错信息包含：`Error: Failed to load native binding`，具体缺失模块为`./jieba.linux-x64-musl.node`，报错堆栈涉及@node-rs/jieba模块与Next.js服务加载流程。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1453)
