---
title: 在FastGPT Docker环境中实现基于LLM的PDF格式优化转换功能
slug: /zh/troubleshoot/fastgpt-docker-llm-pdf-conversion
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3617
source_type: GitHub issue
---

# 在FastGPT Docker环境中实现基于LLM的PDF格式优化转换功能
...
> 使用FastGPT处理PDF文件时，会出现仅能转换块方程、表格格式异常、多行单元格被拆分、复杂嵌套布局无法正常转换的问题，无法满足精准格式转换需求。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3617)
