---
title: 解决FastGPT本地部署修改Docker映射端口后登录报错问题
slug: /zh/troubleshoot/fastgpt-docker-port-mapping-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1701
source_type: GitHub issue
---

# 解决FastGPT本地部署修改Docker映射端口后登录报错问题
...
> 本地部署FastGPT后修改了Docker容器的端口映射配置，使用正确的登录密码时系统提示报错，同时后台服务生成了对应报错日志。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1701)
