---
title: 解决Docker Swarm部署FastGPT后端口无法访问的问题
slug: /zh/troubleshoot/fastgpt-docker-swarm-port-unreachable
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1006
source_type: GitHub issue
---

# 解决Docker Swarm部署FastGPT后端口无法访问的问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 13.5.2、172.33.16；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 用户在Docker Swarm环境部署FastGPT时，使用外部pgvector和Mongo服务，两个服务均可正常为其他应用提供服务。FastGPT容器启动后无报错日志，仅显示如下内容： ``` ▲ Next.js 13.5.2 - Local: http://0692b2bd9f37:3000 - Network: http://172.33.16.9:3000 ✓ Ready in 126ms ``` 容器状态始终正常，但无法访问映射的3003端口。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1006)
