---
title: FastGPT文档对话相关功能的异常排查与解决
slug: /zh/troubleshoot/fastgpt-document-chat-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1550
source_type: GitHub issue
---

# FastGPT文档对话相关功能的异常排查与解决
...
> 用户在使用FastGPT的文档对话功能时，可能出现以下异常情况： 1. 上传长度超过大模型输入上限80%的文档时，无法正常生成总结或回答特定问题； 2. 输入"总结"或"摘要"关键词发起请求时，未按拆分问答逻辑分段处理并合并结果； 3. 上传非文本类文档（如扫描版PDF）时，无法正确解析并提取文档内容； 4. 触发常规问答请求时，无法从上传的文档中准确提取所需信息。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1550)
