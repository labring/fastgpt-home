---
title: 解决FastGPT问题分类+知识库模式下回答重复两遍的问题
slug: /zh/troubleshoot/fastgpt-duplicate-answer-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/948
source_type: GitHub issue
---

# 解决FastGPT问题分类+知识库模式下回答重复两遍的问题
...
> 在FastGPT私有部署的问题分类+知识库模式中，用户发起提问后，系统会将完整回答内容重复输出两遍，用户提供的两张截图可直观展示该重复响应的表现。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/948)
