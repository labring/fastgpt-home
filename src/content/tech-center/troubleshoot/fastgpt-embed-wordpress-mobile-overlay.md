---
title: 解决FastGPT嵌入WordPress后移动端聊天窗口左侧遮挡问题
slug: /zh/troubleshoot/fastgpt-embed-wordpress-mobile-overlay
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2432
source_type: GitHub issue
---

# 解决FastGPT嵌入WordPress后移动端聊天窗口左侧遮挡问题
...
> 用户使用私有部署4.8.7版本的FastGPT，通过免登录窗口发布的应用嵌入WordPress网站后，手机端点击聊天小图标时，左侧聊天窗口会被遮挡。用户尝试更换WordPress主题、添加自定义CSS样式，均无法解决该问题。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2432)
