---
title: 解决FastGPT 4.6.8私有部署版本的Embedding API 404报错问题
slug: /zh/troubleshoot/fastgpt-embedding-api-404-fix-2
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/937
source_type: GitHub issue
---

# 解决FastGPT 4.6.8私有部署版本的Embedding API 404报错问题
...
> FastGPT 4.6.8私有部署版本中，大模型对话功能可正常使用，但知识库模块会提示「Embedding API 404」报错。用户已验证向量模型在one-api上测试正常，通过curl命令直接调用也可正常返回结果，仅FastGPT页面出现该报错。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/937)
