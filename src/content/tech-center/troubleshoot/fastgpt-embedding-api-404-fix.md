---
title: 解决FastGPT配置Embedding-V1向量模型不生效且报404的问题
slug: /zh/troubleshoot/fastgpt-embedding-api-404-fix
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/793
source_type: GitHub issue
---

# 解决FastGPT配置Embedding-V1向量模型不生效且报404的问题
...
> 用户在config.json中添加百度Embedding-V1向量模型配置后，模型无法生效，系统反复抛出“Embedding API 404”报错。日志中会记录`[ERROR] 2024-01-26 08:05:00 Embedding API 404`，附带`{ message: undefined, stack: undefined }`的错误详情。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/793)
