---
title: FastGPT私有部署版嵌入API无响应的排查解决方法
slug: /zh/troubleshoot/fastgpt-embedding-api-not-responding
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3896
source_type: GitHub issue
---

# FastGPT私有部署版嵌入API无响应的排查解决方法
...
> 用户使用v4.8.22私有部署版FastGPT，配置两个可通过Python正常调用的索引模型接口。在FastGPT内测试时，其中一个接口显示报错"Embedding API is not responding"，另一个接口测试成功。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3896)
