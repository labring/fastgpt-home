---
title: 解决FastGPT私有部署中text-embedding-ada-002无可用渠道报错问题
slug: /zh/troubleshoot/fastgpt-embedding-channel-unavailable-2
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/509
source_type: GitHub issue
---

# 解决FastGPT私有部署中text-embedding-ada-002无可用渠道报错问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 v4.6.1；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 用户使用私有部署版本ghcr.io/labring/fastgpt:v4.6.1，添加知识库后，系统抛出Embedding Error InternalServerError: 503，完整报错信息为：当前分组 default 下对于模型 text-embedding-ada-002 无可用渠道 (request id: 2023112319511878560700aZyi3fOR)。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/509)
