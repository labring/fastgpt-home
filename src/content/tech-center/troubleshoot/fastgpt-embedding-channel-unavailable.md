---
title: 解决FastGPT知识库调用text-embedding-ada-002时报无可用渠道的问题
slug: /zh/troubleshoot/fastgpt-embedding-channel-unavailable
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3756
source_type: GitHub issue
---

# 解决FastGPT知识库调用text-embedding-ada-002时报无可用渠道的问题
...
> 使用私有部署版本v4.8.18的FastGPT用户，已在OneAPI中添加text-embedding-ada-002模型，且已在FastGPT配置文件中配置该向量模型，但在使用知识库功能时，系统弹出报错提示：无可用渠道。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3756)
