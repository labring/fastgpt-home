---
title: 解决FastGPT替换嵌入模型后的配置异常问题
slug: /zh/troubleshoot/fastgpt-embeddings-config-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/201
source_type: GitHub issue
---

# 解决FastGPT替换嵌入模型后的配置异常问题
...
> 用户基于FastGPT官方提供的示例配置文件，修改VectorModels字段替换嵌入模型配置后，系统出现异常。具体表现为依赖嵌入模型的功能无法正常运行，如知识库文档上传、向量化处理等流程失败。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/201)
