---
title: 解决FastGPT判断器无法正确识别空输入字符串的问题
slug: /zh/troubleshoot/fastgpt-empty-string-judge-fix
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1199
source_type: GitHub issue
---

# 解决FastGPT判断器无法正确识别空输入字符串的问题
...
> 在FastGPT 4.7私有部署版本中，使用内置判断器时，输入纯空字符串无法被正确判断，实际输出结果未达到预期的false值。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1199)
