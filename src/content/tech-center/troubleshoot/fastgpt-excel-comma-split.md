---
title: 解决FastGPT知识库Excel上传后英文逗号拆分单元格数据的问题
slug: /zh/troubleshoot/fastgpt-excel-comma-split
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4115
source_type: GitHub issue
---

# 解决FastGPT知识库Excel上传后英文逗号拆分单元格数据的问题
...
> 在FastGPT私有部署V4.9.0版本中，将包含英文逗号的Excel文件上传至知识库后，表格内包含英文逗号","的单元格内容会被拆分为多段独立数据，无法保持原单元格的完整内容，仅能通过手动在知识库中编辑修正才能恢复正常显示。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4115)
