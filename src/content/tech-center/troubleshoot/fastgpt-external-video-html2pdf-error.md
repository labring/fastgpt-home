---
title: 解决FastGPT中外部视频URL播放触发html2pdf报错的问题
slug: /zh/troubleshoot/fastgpt-external-video-html2pdf-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4651
source_type: GitHub issue
---

# 解决FastGPT中外部视频URL播放触发html2pdf报错的问题
...
> 在FastGPT中使用本地存储的视频URL时，可以正常播放视频。当使用其他系统提供的可直接打开播放的外部视频URL时，无法正常播放，且浏览器控制台抛出报错：`Uncaught TypeError: Cannot redefine property: toString`，报错来源为`html2pdf.bundle.min.js`，完整报错堆栈包含core-js模块的加载过程。用户已确认跨域配置已处理，排除跨域问题。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4651)
