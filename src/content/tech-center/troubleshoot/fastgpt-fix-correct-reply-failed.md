---
title: 解决FastGPT知识库纠正回复操作失败的问题
slug: /zh/troubleshoot/fastgpt-fix-correct-reply-failed
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/470
source_type: GitHub issue
---

# 解决FastGPT知识库纠正回复操作失败的问题
...
> 执行FastGPT知识库的纠正回复操作时，系统返回"纠正回复Failed"的报错，无法正常完成用户预期的纠正回复成功的操作。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/470)
