---
title: 解决FastGPT生成的日志CSV文件无有效规整结构化内容的问题
slug: /zh/troubleshoot/fastgpt-fix-csv-log-structured-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/5861
source_type: GitHub issue
---

# 解决FastGPT生成的日志CSV文件无有效规整结构化内容的问题
...
> 用户使用FastGPT时，存储的日志CSV文件无法输出有效的整齐结构化内容。实际生成的CSV文件中混杂了大量AI对话的回复内容，占据了主要的文件空间，无法提取到规整的有效日志信息。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/5861)
