---
title: 解决FastGPT向量嵌入结果未正确归一化的异常问题
slug: /zh/troubleshoot/fastgpt-fix-embedding-normalization
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3298
source_type: GitHub issue
---

# 解决FastGPT向量嵌入结果未正确归一化的异常问题
...
> 在FastGPT中使用向量嵌入功能时，返回的嵌入向量未经过L2归一化处理，导致基于向量的检索、匹配等操作出现不符合预期的结果。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3298)
