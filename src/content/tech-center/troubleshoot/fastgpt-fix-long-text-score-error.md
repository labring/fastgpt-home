---
title: 解决FastGPT长文本输入时无法返回AI打分结果的问题
slug: /zh/troubleshoot/fastgpt-fix-long-text-score-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3259
source_type: GitHub issue
---

# 解决FastGPT长文本输入时无法返回AI打分结果的问题
...
> 用户使用FastGPT私有部署版本搭建AI打分工具，配置预设打分规则后，输入短文本可正常按照规则返回分数结果；当输入长度较长的文本时，工具不再返回预设的打分结果，转而生成与打分任务无关的发散性回答内容。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3259)
