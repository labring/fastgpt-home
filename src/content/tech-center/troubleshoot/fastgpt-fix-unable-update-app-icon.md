---
title: 解决FastGPT私有部署版本无法更新应用图标问题
slug: /zh/troubleshoot/fastgpt-fix-unable-update-app-icon
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/5878
source_type: GitHub issue
---

# 解决FastGPT私有部署版本无法更新应用图标问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 V4.14.0；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> FastGPT V4.14.0私有部署版本中，无法完成应用图标更新操作。上传图标文件时，系统直接返回创建预签名URL失败的错误，对应FastGPT日志容器输出报错信息： ``` [Error] 2025-11-07 03:04:54 Failed to create post presigned url { message: AggregateError [ECONNREFUSED]: at internalConnectMultiple (node:net:1117:18)
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/5878)
