---
title: 解决FastGPT大文件输入时AI回复固定200tokens的问题
slug: /zh/troubleshoot/fastgpt-fixed-200-token-reply-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2942
source_type: GitHub issue
---

# 解决FastGPT大文件输入时AI回复固定200tokens的问题
...
> 用户在FastGPT 4.8.11-fix版本中，将AI回复上限配置为1950 tokens。当输入文件内容较少时，AI可正常完成回复，对应的oneapi日志显示`promptTokens=5122, completionTokens=421`，回复符合预期。当输入文件内容较多时，AI仅返回固定长度的回复，oneapi日志中`completionTokens`固定为200，更换本地模型与在线模型后问题依旧存在。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2942)
