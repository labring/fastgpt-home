---
title: 解决FastGPT 4.6.8私有部署版本流程模块执行后无法跳转的问题
slug: /zh/troubleshoot/fastgpt-flow-module-stuck
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/890
source_type: GitHub issue
---

# 解决FastGPT 4.6.8私有部署版本流程模块执行后无法跳转的问题
...
> 在FastGPT 4.6.8私有部署版本的自定义工作流中，HTTP请求模块完成执行后，流程无法继续推进至后续连接的模块。按照复现步骤配置用户问题输入模块，并将其输出连接至文本内容提取模块的content输入位时，流程仅完成前序模块运行，无后续执行日志或节点推进。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/890)
