---
title: 解决FastGPT流程图节点连接增多引发的性能卡顿问题
slug: /zh/troubleshoot/fastgpt-flow-node-performance-lag
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/401
source_type: GitHub issue
---

# 解决FastGPT流程图节点连接增多引发的性能卡顿问题
...
> 用户在使用FastGPT的流式编程界面时，遇到了明显的性能卡顿问题。该问题会随着流程图内节点之间的连接数量增加而加重，节点连接越多，编程环境的操作响应速度越慢，严重影响了流程项目的管理效率与使用体验。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/401)
