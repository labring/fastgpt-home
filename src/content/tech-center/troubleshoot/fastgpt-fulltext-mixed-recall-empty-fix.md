---
title: 解决FastGPT开启全文/混合召回后搜索结果无法为空的问题
slug: /zh/troubleshoot/fastgpt-fulltext-mixed-recall-empty-fix
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/738
source_type: GitHub issue
---

# 解决FastGPT开启全文/混合召回后搜索结果无法为空的问题
...
> 当用户在FastGPT中选择全文召回（fullTextRecall）或混合召回（mixedRecall）模式时，即使检索内容不存在于知识库中，知识库模块的搜索结果也永远不会为空，无法触发空结果的预期逻辑。例如输入知识库中不存在的内容后，依然会返回搜索结果，无法实现空结果的判定效果。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/738)
