---
title: 解决FastGPT部署后Gemini模型对话出现400错误的问题
slug: /zh/troubleshoot/fastgpt-gemini-400-error-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/854
source_type: GitHub issue
---

# 解决FastGPT部署后Gemini模型对话出现400错误的问题
...
> 用户在FastGPT私有部署版本中使用Gemini模型进行对话时，出现400错误。用户已在config.json中配置Gemini模型参数，前期曾有几次测试成功，后续持续返回400错误。更换新的Google API Key后，问题仍然存在。同时OneAPI接入Gemini测试正常，说明Gemini服务本身可正常使用。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/854)
