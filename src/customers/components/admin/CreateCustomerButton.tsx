...
import { createSkeletonCustomer } from '@/app/customers/admin/actions/customers';
...
export default function CreateCustomerButton({
  ...
  const handleCreate = async () => {
    ...
    try {
      const result = await createSkeletonCustomer();
      ...
      router.push(buildAdminCustomerEditHref(result));
    } catch (error) {
