...
import { ADMIN_SORT_OPTIONS, type AdminSolutionSortKey } from '@/customers/lib/solution-search';
...
interface CategoryTabsProps {
  ...
  sortBy: AdminSolutionSortKey;
  onSortChange: (value: AdminSolutionSortKey) => void;
}
